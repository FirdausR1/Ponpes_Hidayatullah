    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-theme-xs space-y-4">
        <form method="GET" action="{{ route('admin.siswa.penempatanKelas') }}" class="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                ...
                <div class="relative">
                    <input type="text" name="q" value="{{ $search }}" placeholder="Cari santri, NISN, no reg..." class="h-10 w-44 sm:w-56 pl-9 pr-3 text-xs bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none">
