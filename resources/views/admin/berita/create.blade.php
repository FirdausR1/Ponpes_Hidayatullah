...
<div class="space-y-6 max-w-5xl mx-auto">
    ...
    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data" class="rounded-2xl border border-gray-200 bg-white shadow-theme-xs p-6 sm:p-8 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="author" name="author" value="{{ old('author', 'Humas Pesantren') }}" placeholder="Contoh: Ust. Hamdan / Humas" class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-xs sm:text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-3 focus:ring-brand-500/10 transition">
                    </div>
                </div>

                <div>
                    <label for="excerpt" class="mb-1.5 block text-xs sm:text-sm font-medium text-gray-700">Ringkasan Singkat (Lead Paragraph)</label>
                    <textarea id="excerpt" name="excerpt" rows="3" placeholder="Ringkasan 1-2 kalimat untuk kartu berita..." class="w-full rounded-lg border border-gray-300 bg-transparent p-3.5 text-xs sm:text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-3 focus:ring-brand-500/10 transition">{{ old('excerpt') }}</textarea>
                </div>
            ...
            <div class="space-y-5">
                <div class="p-5 bg-gray-50/70 rounded-xl border border-gray-200 space-y-4">
                    <h3 class="text-xs font-bold text-gray-800 uppercase tracking-wider">Status Publikasi</h3>
                    ...
                    <p class="text-xs text-gray-500">
                        Artikel berstatus <strong>Published</strong> akan langsung tampil di arsip warta santri publik.
                    </p>
                </div>
                ...
                <div class="p-5 bg-gray-50/70 rounded-xl border border-gray-200 space-y-4">
                    ...
                    <div>
                        <label for="image_file" class="mb-1.5 block text-xs font-medium text-gray-700">Upload File Gambar</label>
