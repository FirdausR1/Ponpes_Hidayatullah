...
<body class="min-h-screen pb-16">
        ...
        <div class="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2.5">
                <div class="bg-slate-800 p-0.5 rounded-lg border border-slate-700 flex text-xs font-medium">
                    ...
                    <a href="{{ route('psb.printCard', ['id' => $reg->id, 'mode' => 'ujian']) }}" class="px-2.5 py-1 rounded transition text-[11px] {{ ($mode ?? 'cv') == 'ujian' ? 'bg-emerald-600 text-white font-bold' : 'text-slate-300 hover:text-white' }}">
                        Hasil Ujian CBT
                    </a>
                    <a href="{{ route('psb.printCard', ['id' => $reg->id, 'mode' => 'all']) }}" class="px-2.5 py-1 rounded transition text-[11px] {{ ($mode ?? 'cv') == 'all' ? 'bg-emerald-600 text-white font-bold' : 'text-slate-300 hover:text-white' }}">
                        Berkas Lengkap (CV + Dokumen + Nilai)
                    </a>
                </div>
    ...
    <div class="max-w-5xl mx-auto px-2">
        ...
        <!-- ========================================== -->
        <!-- SHEET 3: LEMBAR HASIL UJIAN SELEKSI MASUK (CBT) -->
        <!-- ========================================== -->
        ...
        <div class="sheet">
            ...
            <!-- STATUS PENERIMAAN RESMI BANNER -->
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            ...
                            <span class="text-[10px] opacity-90 block">
                                @if($reg->status === 'Diterima')
                                    Berdasarkan evaluasi nilai ujian seleksi masuk CBT (memenuhi standar KKM {{ $cbtKkm }}) serta pemenuhan administrasi pendaftaran santri baru.
                                @elseif($reg->status === 'Ditolak')
                                    Keputusan panitia penerimaan santri baru bersifat mutlak berdasarkan kriteria seleksi yang berlaku.
                                @else
                                    Menunggu kelengkapan hasil ujian, verifikasi pembayaran, atau penetapan keputusan akhir dewan penguji.
                                @endif
                            </span>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-8 text-center text-xs items-end">
                    ...
                    <div class="space-y-1 relative text-center">
                        ...
                        <div class="relative h-20 my-1 flex items-center justify-center">
                            ...
                            <!-- Stempel Resmi di Lapisan Bawah -->
                            @if($showStempel && $stempelImg)
